...
File = pandas.read_csv("Dataset 5 - ISSP Survey.csv",sep=",")
Data = File[["country", "iso_alpha3", "region", "sub_region", "exag_env","climate_crisis","protect_env","sex","age",	"educyrs", "degree","soc_rank","gov_peo","gov_bus","how_bus","how_peo","mem_env","care_env"]]
